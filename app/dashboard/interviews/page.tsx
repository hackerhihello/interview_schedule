    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="p-5 rounded-2xl border border-border bg-card/25 backdrop-blur-sm space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3.5">
          ...
          {/* Date Picker */}
          <div className="flex items-center gap-3">
            {/* Mobile: text input + calendar button */}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4 md:hidden">
          <div className="bg-card rounded-2xl border border-border p-6 w-full max-w-sm space-y-4">
            ...
            <button
              ...
              className="w-full px-4 py-2.5 rounded-xl border border-border bg-secondary hover:bg-secondary/80 text-foreground font-semibold text-xs transition-all"
            >
              Close
            </button>
          </div>
